...
public class MontiThingsDeSer extends MontiThingsDeSerTOP {
  ...
  @Override protected void deserializeSymbols(IMontiThingsScope scope, JsonObject scopeJson) {
    ...
    for (JsonObject symbol : JsonDeSers.getSymbols(scopeJson)) {
      ...
      de.monticore.symboltable.serialization.ISymbolDeSer deSer  = montithings.MontiThingsMill.globalScope().getSymbolDeSer(kind);
      if (null == deSer) {
      ...
      if ("arcbasis._symboltable.ComponentInstanceSymbol".equals(kind)
        ...
        arcbasis._symboltable.ComponentInstanceSymbol s0 = (arcbasis._symboltable.ComponentInstanceSymbol) deSer.deserialize(symbol);
        scope.add(s0);
      }
        ...
        arcbasis._symboltable.ComponentTypeSymbol s1 = (arcbasis._symboltable.ComponentTypeSymbol) deSer.deserialize(symbol);
        scope.add(s1);
        ...
        arcbasis._symboltable.PortSymbol s2 = (arcbasis._symboltable.PortSymbol) deSer.deserialize(symbol);
        scope.add(s2);
      }
        ...
        behavior._symboltable.EveryBlockSymbol s3 = (behavior._symboltable.EveryBlockSymbol) deSer.deserialize(symbol);
        scope.add(s3);
      }
        ...
        de.monticore.scbasis._symboltable.SCStateSymbol s4 = (de.monticore.scbasis._symboltable.SCStateSymbol) deSer.deserialize(symbol);
        scope.add(s4);
      }
        ...
        de.monticore.symbols.basicsymbols._symboltable.DiagramSymbol s5 = (de.monticore.symbols.basicsymbols._symboltable.DiagramSymbol) deSer.deserialize(symbol);
        scope.add(s5);
      }
        ...
        de.monticore.symbols.basicsymbols._symboltable.FunctionSymbol s6 = (de.monticore.symbols.basicsymbols._symboltable.FunctionSymbol) deSer.deserialize(symbol);
        scope.add(s6);
        ...
        de.monticore.symbols.basicsymbols._symboltable.TypeSymbol s7 = (de.monticore.symbols.basicsymbols._symboltable.TypeSymbol) deSer.deserialize(symbol);
        scope.add(s7);
        ...
        de.monticore.symbols.basicsymbols._symboltable.TypeVarSymbol s8 = (de.monticore.symbols.basicsymbols._symboltable.TypeVarSymbol) deSer.deserialize(symbol);
        scope.add(s8);
      }
        ...
        de.monticore.symbols.basicsymbols._symboltable.VariableSymbol s9 = (de.monticore.symbols.basicsymbols._symboltable.VariableSymbol) deSer.deserialize(symbol);
        scope.add(s9);
      }
        ...
        de.monticore.symbols.oosymbols._symboltable.FieldSymbol s10 = (de.monticore.symbols.oosymbols._symboltable.FieldSymbol) deSer.deserialize(symbol);
        scope.add(s10);
      }
        ...
        de.monticore.symbols.oosymbols._symboltable.MethodSymbol s11 = (de.monticore.symbols.oosymbols._symboltable.MethodSymbol) deSer.deserialize(symbol);
        scope.add(s11);
      }
        ...
        de.monticore.symbols.oosymbols._symboltable.OOTypeSymbol s12 = (de.monticore.symbols.oosymbols._symboltable.OOTypeSymbol) deSer.deserialize(symbol);
        scope.add(s12);
        ...
        genericarc._symboltable.ArcTypeParameterSymbol s13 = (genericarc._symboltable.ArcTypeParameterSymbol) deSer.deserialize(symbol);
        scope.add(s13);
      }
        ...
        variablearc._symboltable.ArcFeatureSymbol s14 = (variablearc._symboltable.ArcFeatureSymbol) deSer.deserialize(symbol);
        scope.add(s14);
      }
      else {
