...
public class SD4ComponentTestingCLI {
  ...
  public ASTSD4Artifact parse(String model) {
    try {
      SD4ComponentTestingParser parser = SD4ComponentTestingMill.parser();
      Optional<ASTSD4Artifact> optAst = parser.parse(model);
