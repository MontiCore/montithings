...
public class CoCoTest extends AbstractCoCoTest {
	...
	public void testAJavaBehaviorInComponents() {
		...
		checkInvalid(new MontiArcCoCoChecker().addCoCo(new NoAJavaBehaviourInComponents()), node,
				new ExpectedErrorInfo(1, "xMA300"));
	}
	...
	public void testJavaImports() {
		...
		checkInvalid(new MontiArcCoCoChecker().addCoCo(new NoJavaImportsForCPPGenerator()), node,
				new ExpectedErrorInfo(1, "xMA301"));
	}
