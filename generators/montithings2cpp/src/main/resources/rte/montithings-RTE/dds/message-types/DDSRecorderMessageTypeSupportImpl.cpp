...
bool operator<<(Serializer& strm, const DDSRecorderMessage::Message& stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm << stru.instance_name.in())
    && (strm << stru.id)
    && (strm << stru.type)
    && (strm << stru.timestamp)
...
bool operator>>(Serializer& strm, DDSRecorderMessage::Message& stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm >> stru.instance_name.out())
    && (strm >> stru.id)
    && (strm >> stru.type)
    && (strm >> stru.timestamp)
...
bool operator<<(Serializer& strm, KeyOnly<const DDSRecorderMessage::Message> stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm << stru.t.instance_name.in());
}
...
bool operator>>(Serializer& strm, KeyOnly<DDSRecorderMessage::Message> stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm >> stru.t.instance_name.out());
}
...
struct MetaStructImpl<DDSRecorderMessage::Message> : MetaStruct {
  ...
  {
    static const char* names[] = {"instance_name", "id", "type", "timestamp", "serialized_vector_clock", "topic", "msg_id", "msg_content", "message_delays", 0};
    return names;
  }
...
struct MetaStructImpl<DDSRecorderMessage::Command> : MetaStruct {
  ...
  const char** getFieldNames() const
  {
    static const char* names[] = {"instance_name", "cmd", 0};
    return names;
  }
...
struct MetaStructImpl<DDSRecorderMessage::CommandReply> : MetaStruct {
  ...
  const char** getFieldNames() const
  {
    static const char* names[] = {"instance_name", "command_id", "content", 0};
    return names;
  }
...
bool operator<<(Serializer& strm, const DDSRecorderMessage::Acknowledgement& stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm << stru.sending_instance.in())
...
bool operator>>(Serializer& strm, DDSRecorderMessage::Acknowledgement& stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm >> stru.sending_instance.out())
...
bool operator<<(Serializer& strm, KeyOnly<const DDSRecorderMessage::Acknowledgement> stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm << stru.t.sending_instance.in());
}
...
bool operator>>(Serializer& strm, KeyOnly<DDSRecorderMessage::Acknowledgement> stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm >> stru.t.sending_instance.out());
}
...
struct MetaStructImpl<DDSRecorderMessage::Acknowledgement> : MetaStruct {
  ...
  const char** getFieldNames() const
  {
    static const char* names[] = {"sending_instance", "receiving_instance", "port_name", "acked_id", "serialized_vector_clock", 0};
    return names;
  }
