/* Generated by /home/luke/Projects/OpenDDS/bin/opendds_idl version 3.15 (ACE version 6.2a_p19) running on input file /home/luke/Projects/montithings/dds-sample-application2/target/generated-sources/montithings-RTE/dds/message-types/DDSRecorderMessage.idl */
...
struct MetaStructImpl<DDSRecorderMessage::Message> : MetaStruct {
  ...
  {
    static const char* names[] = {"id", "instance_name", "type", "timestamp", "topic", "msg_id", "msg_content", "message_delays", 0};
    return names;
  }
...
void gen_find_size(const DDSRecorderMessage::Acknowledgement& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.id);
  find_size_ulong(size, padding);
  size += ACE_OS::strlen(stru.instance.in()) + 1;
  if ((size + padding) % 4) {
    padding += 4 - ((size + padding) % 4);
  }
...
void gen_find_size(KeyOnly<const DDSRecorderMessage::Acknowledgement> stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.t.id);
  find_size_ulong(size, padding);
  size += ACE_OS::strlen(stru.t.instance.in()) + 1;
}
...
void vwrite(OpenDDS::DCPS::ValueWriter& value_writer, const DDSRecorderMessage::Acknowledgement& value)
{
  ...
  value_writer.write_int32(value.id);
  value_writer.end_field();
  value_writer.begin_field("instance");
  value_writer.write_string(value.instance);
  value_writer.end_field();
...
struct MetaStructImpl<DDSRecorderMessage::Acknowledgement> : MetaStruct {
  ...
  bool isDcpsKey(const char* field) const
  {
    ...
    if (!ACE_OS::strcmp(field, "instance")) {
      return true;
    }
    return false;
  }
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "instance") == 0) {
      return typed.instance.in();
    }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    if (std::strcmp(field, "instance") == 0) {
      TAO::String_Manager val;
      if (!(ser >> val.out())) {
        throw std::runtime_error("Field 'instance' could not be deserialized");
      }
      return val;
    } else {
      ACE_CDR::ULong len;
      if (!(ser >> len)) {
        throw std::runtime_error("String 'instance' length could not be deserialized");
      }
      if (!ser.skip(static_cast<ACE_UINT16>(len))) {
        throw std::runtime_error("String 'instance' contents could not be skipped");
      }
    }
    if (std::strcmp(field, "acked_id") == 0) {
      ACE_CDR::Long val;
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ...
    if (std::strcmp(field, "instance") == 0) {
      return make_field_cmp(&T::instance, next);
    }
    if (std::strcmp(field, "acked_id") == 0) {
  ...
  const char** getFieldNames() const
  {
    static const char* names[] = {"id", "instance", "acked_id", "serialized_vector_clock", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "instance") == 0) {
      return &static_cast<const T*>(stru)->instance;
    }
    if (std::strcmp(field, "acked_id") == 0) {
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "instance") == 0) {
      static_cast<T*>(lhs)->instance = *static_cast<const TAO::String_Manager*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "acked_id") == 0) {
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "instance") == 0) {
      return 0 == ACE_OS::strcmp(static_cast<const T*>(lhs)->instance.in(), static_cast<const T*>(rhs)->instance.in());
    }
    if (std::strcmp(field, "acked_id") == 0) {
