/* -*- C++ -*- */
/* Generated by opendds_idl version 3.15 (ACE version 6.2a_p19) running on input file DDSRecorderMessage.idl */
#ifndef OPENDDS_IDL_GENERATED_DDSRECORDERMESSAGETYPESUPPORTIMPL_H_P6P5PA
#define OPENDDS_IDL_GENERATED_DDSRECORDERMESSAGETYPESUPPORTIMPL_H_P6P5PA
...
struct  Message_OpenDDS_KeyLessThan {
  bool operator()(const DDSRecorderMessage::Message&, const DDSRecorderMessage::Message&) const
  {
...
struct  Command_OpenDDS_KeyLessThan {
  bool operator()(const DDSRecorderMessage::Command&, const DDSRecorderMessage::Command&) const
  {
    // With no keys, return false to allow use of
    // map with just one entry
    return false;
...
struct  CommandReply_OpenDDS_KeyLessThan {
  bool operator()(const DDSRecorderMessage::CommandReply&, const DDSRecorderMessage::CommandReply&) const
  {
    // With no keys, return false to allow use of
    // map with just one entry
    return false;
...
struct  Acknowledgement_OpenDDS_KeyLessThan {
  bool operator()(const DDSRecorderMessage::Acknowledgement&, const DDSRecorderMessage::Acknowledgement&) const
  {
    // With no keys, return false to allow use of
    // map with just one entry
    return false;
...
#endif /* OPENDDS_IDL_GENERATED_DDSRECORDERMESSAGETYPESUPPORTIMPL_H_P6P5PA */
