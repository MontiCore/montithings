...
#ifndef OPENDDS_IDL_GENERATED_DDSRECORDERMESSAGETYPESUPPORTIMPL_H_70UPNG
#define OPENDDS_IDL_GENERATED_DDSRECORDERMESSAGETYPESUPPORTIMPL_H_70UPNG
...
struct  Acknowledgement_OpenDDS_KeyLessThan {
  bool operator()(const DDSRecorderMessage::Acknowledgement& v1, const DDSRecorderMessage::Acknowledgement& v2) const
  {
    ...
    if (v1.id < v2.id) return true;
    if (v2.id < v1.id) return false;
    if (v1.instance < v2.instance) return true;
    if (v2.instance < v1.instance) return false;
    return false;
  }
};
}
...
#endif /* OPENDDS_IDL_GENERATED_DDSRECORDERMESSAGETYPESUPPORTIMPL_H_70UPNG */
