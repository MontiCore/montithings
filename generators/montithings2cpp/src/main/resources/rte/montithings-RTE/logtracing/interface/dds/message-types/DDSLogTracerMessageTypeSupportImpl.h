...
#ifndef OPENDDS_IDL_GENERATED_DDSLOGTRACERMESSAGETYPESUPPORTIMPL_H_V9IC4L
#define OPENDDS_IDL_GENERATED_DDSLOGTRACERMESSAGETYPESUPPORTIMPL_H_V9IC4L
...
struct  Request_OpenDDS_KeyLessThan {
  bool operator()(const DDSLogTracerMessage::Request&, const DDSLogTracerMessage::Request&) const
  {
...
#endif /* OPENDDS_IDL_GENERATED_DDSLOGTRACERMESSAGETYPESUPPORTIMPL_H_V9IC4L */
