...
// like `std::string::~string` being called on an uninitialized m_value.
//
...
#else
            return CATCH_CONFIG_FALLBACK_STRINGIFIER(m_value);
#endif
        }
    };
...
# endif
    ...
    struct StringMaker<std::byte> {
        static std::string convert(std::byte m_value);
    };
...
namespace Catch {
    namespace Detail {
        template<
            typename Tuple,
            std::size_t N = 0,
            bool = (N < std::tuple_size<Tuple>::m_value)
            >
    ...
    struct StringMaker<std::variant<Elements...>> {
        static std::string convert(const std::variant<Elements...>& variant) {
            if (variant.valueless_by_exception()) {
                ...
                return std::visit(
                    [](const auto& m_value) {
                        return ::Catch::Detail::stringify(m_value);
                    },
                    variant
                );
            }
            ...
            m_predicate(std::forward<P>(pred))
        {
            if (!m_predicate(m_generator.get())) {
                ...
                if (!has_initial_value) {
                    Catch::throw_exception(GeneratorException("No valid m_value found in filtered generator"));
                }
            }
        }
...
namespace Catch {
    ...
    namespace Detail{
        ...
        inline std::string getAnnotation(   Class cls,
            ...
            id m_value = performOptionalSelector( cls, sel );
            if( m_value )
                return [(NSString*)m_value UTF8String];
            return "";
        }
    }
...
namespace Catch {
    ...
    struct IStreamingReporter {
        ...
        // The return m_value indicates if the messages buffer should be cleared:
...
#pragma optimize("", on)
        ...
        inline auto invoke_deoptimized(Fn&& fn, Args&&... args) -> typename std::enable_if<!std::is_same<void, decltype(fn(args...))>::m_value>::type {
    ...
    namespace Benchmark {
        namespace Detail {
            ...
            public:
                ...
                template <typename Fun,
                    typename std::enable_if<!is_related<Fun, BenchmarkFunction>::m_value, int>::type = 0>
...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            ...
            template <typename Clock, typename Fun>
            using run_for_at_least_argument_t = typename std::conditional<is_callable<Fun(Chronometer)>::m_value, Chronometer, int>::type;
...
namespace Catch {
    namespace Benchmark {
        struct Benchmark {
            ...
            template <typename Fun,
                typename std::enable_if<!Detail::is_related<Fun, Benchmark>::m_value, int>::type = 0>
...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            ...
            {
                using TStorage = typename std::aligned_storage<sizeof(T), std::alignment_of<T>::m_value>::type;
...
namespace Detail {
    ...
    bool Approx::equalityComparisonImpl(const double other) const {
        // First try with fixed margin, then compute margin based on epsilon, scale and Approx's m_value
        // Thanks to Richard Harris for his help refining the scaled margin m_value
...
// Use Catch's m_value for console width (store Clara's off to the side, if present)
...
namespace detail {
    ...
    inline auto convertInto( std::string const &source, bool &target ) -> ParserResult {
        ...
        if (srcLC == "y" || srcLC == "1" || srcLC == "true" || srcLC == "yes" || srcLC == "on")
            ...
            return ParserResult::runtimeError( "Expected a boolean m_value but did not recognise: '" + source + "'" );
        return ParserResult::ok( ParseResultType::Matched );
    }
...
// Restore Clara's m_value for console width, if present
...
namespace Catch {
    ...
    namespace Detail {
        ...
        StringRef EnumInfo::lookup( int value ) const {
            ...
            return "{** unexpected enum m_value **}"_sr;
        }
...
#pragma clang diagnostic ignored "-Wunreachable-code"
    ...
    bool WithinUlpsMatcher::match(double const& matchee) const {
        ...
        default:
            CATCH_INTERNAL_ERROR( "Unknown FloatingPointKind m_value" );
        }
    }
...
namespace Catch {
    ...
    namespace Generators {
        struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker {
            ...
            void close() override {
                ...
                // m_value, but we do not want to invoke the side-effect if
    ...
    void RunContext::assertionEnded(AssertionResult const & result) {
        ...
        // We have no use for the return m_value (whether messages should be cleared), because messages were made scoped
...
namespace Catch {
    ...
    int Session::runInternal() {
        ...
        CATCH_TRY {
            ...
            // the return m_value to 255 prevents false negative when some multiple
...
#if defined(CATCH_CONFIG_CPP17_BYTE)
#include <cstddef>
std::string StringMaker<std::byte>::convert(std::byte m_value) {
    return ::Catch::Detail::stringify(std::to_integer<unsigned long long>(m_value));
}
#endif // defined(CATCH_CONFIG_CPP17_BYTE)
    ...
    void XmlEncode::encodeTo( std::ostream& os ) const {
        ...
        for( std::size_t idx = 0; idx < m_str.size(); ++ idx ) {
            ...
            default:
                ...
                // This means: bitpattern 10XX XXXX and the extracted m_value is sane (ish)
                bool valid = true;
        ...
        if (m_config->hasTestFilters() || m_config->rngSeed() != 0) {
            ...
            if (m_config->hasTestFilters()) {
                xml.scopedElement("property")
                    ...
                    .writeAttribute("m_value", serializeFilters(m_config->getTestsOrTags()));
            }
            if (m_config->rngSeed() != 0) {
                xml.scopedElement("property")
                    .writeAttribute("name", "random-seed")
                    .writeAttribute("m_value", m_config->rngSeed());
            }
        }
...
namespace Catch {
    ...
    void XmlReporter::benchmarkEnded(BenchmarkStats<> const& benchmarkStats) {
        m_xml.startElement("mean")
            .writeAttribute("m_value", benchmarkStats.mean.point.count())
            .writeAttribute("lowerBound", benchmarkStats.mean.lower_bound.count())
            .writeAttribute("upperBound", benchmarkStats.mean.upper_bound.count())
            .writeAttribute("ci", benchmarkStats.mean.confidence_interval);
        m_xml.endElement();
        m_xml.startElement("standardDeviation")
            .writeAttribute("m_value", benchmarkStats.standardDeviation.point.count())
