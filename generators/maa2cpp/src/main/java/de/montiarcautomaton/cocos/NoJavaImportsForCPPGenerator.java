...
public class NoJavaImportsForCPPGenerator implements MontiArcASTComponentCoCo {
  ...
  /* Checks that no Java imports are in components that are generated with the CPP generator. */
  @Override
  public void check(ASTComponent node) {
    ...
    if (symbol.getImports().size() > 0) {
      Log.error(
          String.format("0xMA301 Components generated by the CPP generator"
              + "should not contain Java import statements.",
              node.getName()));
    }
