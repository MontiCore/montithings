...
public class Utils {
  ...
  public static String getNameOfOuterScope(String input) {
    return capitalize(input.split("__")[0]);
  }

  public static String getFactName(String input) {
    return input.replace(input.split("__")[0] + "__", "");
  }
}
