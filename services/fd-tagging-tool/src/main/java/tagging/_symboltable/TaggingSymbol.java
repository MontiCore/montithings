...
public class TaggingSymbol extends TaggingSymbolTOP{
    ...
    public TaggingSymbol(String name) { super(name);}

    public Optional<FeatureDiagramSymbol> getFeatureDiagramSymbol () {return this.featureDiagramSymbol;}

    public void setFeatureDiagramSymbol (Optional<FeatureDiagramSymbol> f) {this.featureDiagramSymbol = f;}
