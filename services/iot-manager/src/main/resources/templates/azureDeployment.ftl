          ...
          <#list modules as moduleName>
            "${moduleName?replace(".", "-")}": {
              "settings": {
                ...
                "createOptions": "{\"Entrypoint\":[\"sh\",\"entrypoint.sh\",\"-n\", \"${moduleName}\", \"--brokerHostname\", \"${networkInfo.getMqttHost()}\", \"--brokerPort\", \"${networkInfo.getMqttPort()?c}\", \"--localBrokerPort\", \"4230\"],\"NetworkingConfig\": {\"EndpointsConfig\": {\"host\": {}}},\"HostConfig\": {\"NetworkMode\": \"host\",\"Mounts\": [{\"Target\": \"/etc/montithings\",\"Source\": \"/etc/montithings\",\"Type\": \"bind\",\"ReadOnly\": true}]}}"
              },
              "type": "docker",
              "status": "running",
